      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-[120px]">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          ...
          <div className="flex gap-4">
            <Link href="https://www.facebook.com/mariekitzxc" target="_blank" rel="noopener noreferrer" className="p-2 hover:bg-gray-100 dark:hover:bg-white/10 rounded-full transition-colors dark:text-white">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-50 dark:border-white/5 text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-widest font-medium">
          <p className="mb-4 md:mb-0">© 2026 Keith Caballero. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
